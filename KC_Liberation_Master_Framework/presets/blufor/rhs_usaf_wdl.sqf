...
light_vehicles = [
    ...
    ["rhsusf_m1025_w_mk19",100,75,50],                                  // M1025A2 (Mk19)
    ["rhsusf_m998_w_2dr_fulltop",0,0,0],                                // M1097A2 (2D)
    ["rhsusf_m998_w_2dr_halftop",0,0,0],                                // M1097A2 (2D / open back)
    ["rhsusf_M1220_usarmy_wd",200,0,100],                                // M1220
    ["rhsusf_M1220_M2_usarmy_wd",200,50,100],                            // M1220 (M2)
    ["rhsusf_M1220_MK19_usarmy_wd",200,75,100],                          // M1220 (Mk19)
    ["rhsusf_M1232_usarmy_wd",200,0,100],                                // M1232
    ["rhsusf_M1232_M2_usarmy_wd",200,50,100],                            // M1232 (M2)
    ["rhsusf_M1232_MK19_usarmy_wd",200,75,100],                          // M1232 (Mk19)
    ["rhsusf_M1240a1_mk19_usmc_wd",175,75,75],                          // M1240A1 M-ATV  (MK19)
    ["rhsusf_M1240a1_mk19crows_usmc_wd",175,150,75],                     // M1240A1 M-ATV  (MK19 Crows)
    ["rhsusf_M1240a1_m240_usmc_wd",175,25,75],                          // M1240A1 M-ATV  (M240)
    ["rhsusf_M1240a1_m2_usmc_wd",175,50,75],                            // M1240A1 M-ATV  (M2)
    ["rhsusf_M1240a1_m2crows_usmc_wd",175,100,75],                       // M1240A1 M-ATV  (M2 Crows)
    ...
    ["rhsusf_M1230a1_usarmy_wd",200,0,100],                              // M1230A1 (MEDEVAC)
    ["rhsusf_M1237_M2_usarmy_wd",225,50,100],                            // M1237 (O-GKP / M2)
    ["rhsusf_M1083A1P2_wd_open_fmtv_usarmy",100,0,100],                  // M1083A1P2 Transport
    ["rhsusf_M1083A1P2_wd_fmtv_usarmy",100,0,100],                       // M1083A1P2 Transport (Covered)
    ["rhsusf_M1083A1P2_WD_flatbed_fmtv_usarmy",100,0,100],               // M1083A1P2
    ["rhsusf_M977A4_BKIT_usarmy_wd",150,0,100],                          // M977A4 BKIT
    ["rhsusf_M977A4_BKIT_M2_usarmy_wd",150,50,100],                      // M977A4 BKIT (HMG)
    ["rhsusf_M1117_W",150,200,75],                                       // M1117 ASV
...
heavy_vehicles = [
    ["rhsusf_m113_usarmy",300,50,150],                                  // M113A3 (M2)
    ["rhsusf_m113_usarmy_MK19",300,75,150],                             // M113A3 (Mk19)
    ["rhsusf_m113_usarmy_medical",300,0,150],                           // M113A3 (Medical)
    ["rhsusf_stryker_m1126_m2_wd",400,100,200],                         // Stryker (M2)
    ["rhsusf_stryker_m1126_mk19_wd",400,150,200],                       // Stryker (MK19)
    ["rhsusf_stryker_m1127_m2_wd",450,50,200],                         // Stryker (M2-LRAS3)
    ["rhsusf_stryker_m1132_m2_wd",450,100,200],                         // Stryker (SMP/M2)
    ["RHS_M2A2_BUSKI_WD",500,300,300],                                  // M2A2ODS (Busk I)
...
static_vehicles = [
    ["RHS_M2StaticMG_MiniTripod_WD",25,50,0],                           // Mk2 HMG .50
    ["RHS_M2StaticMG_WD",25,50,0],                                      // Mk2 HMG .50 (Raised)
    ["RHS_MK19_TriPod_WD",25,75,0],                                     // Mk19 GMG 20mm
    ["RHS_TOW_TriPod_WD",50,150,0],                                     // TOW (AT)
    ["RHS_Stinger_AA_pod_WD",50,150,0],                                 // Stinger (AA)
    ["RHS_M252_USMC_WD",100,250,0],                                      // M252 Mortar
    ["RHS_M119_WD",250,500,0]                                           // M119A2
];
...
buildings = [
    ...
    ["Land_Cargo_House_V1_F",100,0,0],
    ["Land_Cargo_Patrol_V1_F",200,0,0],
    ...
    ["Land_BagFence_Round_F",25,0,0],
    ["Land_BagFence_Short_F",25,0,0],
    ["Land_BagFence_Long_F",25,0,0],
    ["Land_BagFence_Corner_F",25,0,0],
    ["Land_BagFence_End_F",25,0,0],
    ["Land_BagBunker_Small_F",50,0,0],
    ["Land_BagBunker_Large_F",100,0,0],
    ["Land_BagBunker_Tower_F",150,0,0],
    ["Land_HBarrier_1_F",25,0,0],
    ["Land_HBarrier_3_F",25,0,0],
    ["Land_HBarrier_5_F",25,0,0],
    ["Land_HBarrier_Big_F",25,0,0],
    ["Land_HBarrierWall4_F",25,0,0],
    ["Land_HBarrierWall6_F",25,0,0],
    ["Land_HBarrierWall_corner_F",25,0,0],
    ["Land_HBarrierWall_corridor_F",25,0,0],
    ["Land_HBarrierTower_F",100,0,0],
    ["Land_CncBarrierMedium_F",25,0,0],
    ["Land_CncBarrierMedium4_F",25,0,0],
    ["Land_Concrete_SmallWall_4m_F",25,0,0],
    ["Land_Concrete_SmallWall_8m_F",25,0,0],
    ["Land_CncShelter_F",25,0,0],
    ["Land_CncWall1_F",25,0,0],
    ["Land_CncWall4_F",25,0,0],
...
support_vehicles = [
    ...
    ["Box_NATO_Ammo_F",0,25,0],
    ["Box_NATO_wpsLaunch_F",0,250,0],
    ["Box_IND_WpsLaunch_F",0,250,0],
    ["Box_EAF_WpsLaunch_F",0,500,0],
    ["ACE_Wheel",10,0,0],
    ["ACE_Track",10,0,0],
