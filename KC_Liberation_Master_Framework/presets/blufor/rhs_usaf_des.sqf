...
heavy_vehicles = [
    ["rhsusf_m113d_usarmy",300,50,150],                                  // M113A3 (M2)
    ["rhsusf_m113d_usarmy_MK19",300,75,150],                             // M113A3 (Mk19)
    ["rhsusf_m113d_usarmy_medical",300,0,150],                           // M113A3 (Medical)
    ["rhsusf_stryker_m1126_m2_d",400,100,200],                           // Stryker (M2)
    ["rhsusf_stryker_m1126_mk19_d",400,150,200],                         // Stryker (MK19)
    ["rhsusf_stryker_m1127_m2_d",450,50,200],                           // Stryker (M2-LRAS3)
    ["rhsusf_stryker_m1132_m2_d",450,100,200],                           // Stryker (SMP/M2)
    ["RHS_M2A2_BUSKI",500,300,300],                                      // M2A2ODS (Busk I)
    ["RHS_M2A3_BUSKIII",600,300,300],                                    // M2A3 (Busk III)
    ["RHS_M6",600,300,300],                                              // M6A2 (Linebacker)
