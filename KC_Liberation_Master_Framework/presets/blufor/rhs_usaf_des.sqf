...
heavy_vehicles = [
    ...
    ["rhsusf_m1a2sep2d_usarmy",1250,1250,500],                             // M1A2 SEP v1 (Operations)
	["rhsusf_m1a2sep1tuskiid_usarmy",1500,1250,750],                             // Tusk
    ["itc_land_rhsusf_m109d_usarmy",750,2000,300]                                 // M109A6
];
...
elite_vehicles = [
    ...
    "itc_land_rhsusf_m109d_usarmy",                                              // M109A6
